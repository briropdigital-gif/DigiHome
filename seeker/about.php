...
$reviews = get_reviews_for_display(current_user()['id'] ?? null, 12);
$teamMembers = get_team_members_with_contacts();
$pageTitle = 'DigiHome | About';
$pageDescription = 'Read about DigiHome vision, operations model, and role-based experience.';
...
<section class="section-shell" data-reveal>
    <div class="section-head">
        <div>
            ...
            <p>Trusted feedback from our users.</p>
        </div>
    </div>
    <div class="card-grid">
...
<section class="section-shell" data-reveal>
    <div class="section-head">
        <div>
            <h2>Our Team</h2>
            <p>Meet the people behind DigiHome.</p>
        </div>
    </div>
