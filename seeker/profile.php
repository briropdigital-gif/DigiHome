...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$uploadedProfile = store_profile_image_upload('profile_picture_file', (string) ($user['profile_picture'] ?? ''), (string) ($user['role'] ?? 'property_seeker'));
...
$user = current_user();
$pageTitle = 'DigiHome | Property Seeker Profile';
...
<section class="section-shell profile-layout" data-reveal>
	...
	<div class="profile-edit card-shell">
		<form method="post" class="form-grid" enctype="multipart/form-data">
			...
			<label class="field-card"><span>New Password</span><div class="password-field"><input id="seeker-profile-password" type="password" name="password" placeholder="Leave blank to keep existing password"><button type="button" class="ghost-button password-toggle" data-password-toggle="seeker-profile-password" aria-label="Show password" title="Show password"><i class="fa-solid fa-eye" aria-hidden="true"></i></button></div></label>
			<label class="field-card"><span>Confirm Password</span><div class="password-field"><input id="seeker-profile-confirm-password" type="password" name="confirm_password" placeholder="Repeat new password if changing"><button type="button" class="ghost-button password-toggle" data-password-toggle="seeker-profile-confirm-password" aria-label="Show password" title="Show password"><i class="fa-solid fa-eye" aria-hidden="true"></i></button></div></label>
