...
$pageTitle = 'DigiHome | Property Seeker Sign In';
$pageDescription = 'Sign in to DigiHome as a Property Seeker.';
?>
	...
	<form method="post" class="form-grid">
		...
		<label class="field-card full-span">
			...
			<div class="password-field">
				<input id="seeker-login-password" type="password" name="password" placeholder="Enter password" required>
				<button type="button" class="ghost-button password-toggle" data-password-toggle="seeker-login-password" aria-label="Show password" title="Show password"><i class="fa-solid fa-eye" aria-hidden="true"></i></button>
			</div>
		</label>
