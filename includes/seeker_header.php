...
$pageTitle = $pageTitle ?? 'DigiHome | Property Seeker Portal';
$pageDescription = $pageDescription ?? 'Search, unlock, and track verified listings with a polished property seeker experience.';
$brandHref = '/DigiHome/seeker/home.php';
$siteContent = get_site_content_map();
$brandTitle = $siteContent['system_name'] ?? 'DigiHome';
$brandTagline = $siteContent['header_description'] ?? 'Search verified listings, save favorites, and unlock trusted property details.';
$bodyClass = 'theme-seeker';
$requestPath = parse_url($_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH) ?: '';
$navItems = [
	['label' => 'Home', 'href' => '/DigiHome/seeker/home.php', 'icon' => 'fa-house'],
	['label' => 'Listings', 'href' => '/DigiHome/seeker/listings.php', 'icon' => 'fa-building'],
	['label' => 'Favorites', 'href' => '/DigiHome/seeker/favorites.php', 'icon' => 'fa-heart'],
	['label' => 'Unlocked', 'href' => '/DigiHome/seeker/unlocked.php', 'icon' => 'fa-lock-open'],
	['label' => 'Chat', 'href' => '/DigiHome/seeker/chat.php', 'icon' => 'fa-comments'],
	['label' => 'Rate Us', 'href' => '/DigiHome/seeker/rate-us.php', 'icon' => 'fa-star'],
	['label' => 'About', 'href' => '/DigiHome/seeker/about.php', 'icon' => 'fa-circle-info'],
	['label' => 'Contact', 'href' => '/DigiHome/seeker/contact.php', 'icon' => 'fa-envelope'],
];
$flashMap = [
...
$currentUri = (string) ($_SERVER['REQUEST_URI'] ?? '/DigiHome/seeker/home.php');
$switchAccountHref = account_hub_path('login') . '&return=' . urlencode($currentUri);
$logoutHref = logout_path() . '?scope=current&role=' . urlencode('property_seeker');
