...
$pageTitle = $pageTitle ?? 'DigiHome | Marketer Portal';
$pageDescription = $pageDescription ?? 'Manage property owners, submit listings, and monitor marketer activity.';
$brandHref = '/DigiHome/marketer/home.php';
$siteContent = get_site_content_map();
$brandTitle = $siteContent['system_name'] ?? 'DigiHome';
$brandTagline = $siteContent['header_description'] ?? 'Register owners, submit listings, and manage marketer operations.';
$bodyClass = 'theme-marketer';
$requestPath = parse_url($_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH) ?: '';
$navItems = [
    ['label' => 'Home', 'href' => '/DigiHome/marketer/home.php', 'icon' => 'fa-house'],
    ['label' => 'Listings', 'href' => '/DigiHome/marketer/listings.php', 'icon' => 'fa-building'],
    ['label' => 'Commissions', 'href' => '/DigiHome/marketer/commissions.php', 'icon' => 'fa-coins'],
    ['label' => 'Register Owner', 'href' => '/DigiHome/marketer/register-owner.php', 'icon' => 'fa-user-plus'],
    ['label' => 'Create Listing', 'href' => '/DigiHome/marketer/listing.php', 'icon' => 'fa-square-plus'],
    ['label' => 'Chat', 'href' => '/DigiHome/marketer/chat.php', 'icon' => 'fa-comments'],
    ['label' => 'Rate Us', 'href' => '/DigiHome/marketer/rate-us.php', 'icon' => 'fa-star'],
    ['label' => 'About', 'href' => '/DigiHome/marketer/about.php', 'icon' => 'fa-circle-info'],
    ['label' => 'Contact', 'href' => '/DigiHome/marketer/contact.php', 'icon' => 'fa-envelope'],
];
$flashMap = [
...
$currentUri = (string) ($_SERVER['REQUEST_URI'] ?? '/DigiHome/marketer/home.php');
$switchAccountHref = account_hub_path('login') . '&return=' . urlencode($currentUri);
$logoutHref = logout_path() . '?scope=current&role=' . urlencode('marketer');
