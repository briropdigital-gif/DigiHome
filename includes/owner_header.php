...
$pageTitle = $pageTitle ?? 'DigiHome | Property Owner Portal';
$pageDescription = $pageDescription ?? 'Manage property submissions, listing performance, unlock history, and marketer relationships.';
$brandHref = '/DigiHome/owner/home.php';
$siteContent = get_site_content_map();
$brandTitle = $siteContent['system_name'] ?? 'DigiHome';
$brandTagline = $siteContent['header_description'] ?? 'Create quality listings, track verification, and monitor buyer activity.';
$bodyClass = 'theme-owner';
$requestPath = parse_url($_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH) ?: '';
$navItems = [
	['label' => 'Home', 'href' => '/DigiHome/owner/home.php', 'icon' => 'fa-house'],
	['label' => 'Listings', 'href' => '/DigiHome/owner/listings.php', 'icon' => 'fa-building'],
	['label' => 'Create Listing', 'href' => '/DigiHome/owner/listing.php', 'icon' => 'fa-square-plus'],
	['label' => 'Chat', 'href' => '/DigiHome/owner/chat.php', 'icon' => 'fa-comments'],
	['label' => 'Rate Us', 'href' => '/DigiHome/owner/rate-us.php', 'icon' => 'fa-star'],
	['label' => 'About', 'href' => '/DigiHome/owner/about.php', 'icon' => 'fa-circle-info'],
	['label' => 'Contact', 'href' => '/DigiHome/owner/contact.php', 'icon' => 'fa-envelope'],
];
$flashMap = [
...
$currentUri = (string) ($_SERVER['REQUEST_URI'] ?? '/DigiHome/owner/home.php');
$switchAccountHref = account_hub_path('login') . '&return=' . urlencode($currentUri);
$logoutHref = logout_path() . '?scope=current&role=' . urlencode('property_owner');
