...
if (!$user || !user_has_any_role(['marketer'])) {
    add_flash('danger', 'Please login as a marketer to access About.');
...
$pageTitle = 'DigiHome | Marketer About';
$pageDescription = 'Read platform information relevant to marketers.';
